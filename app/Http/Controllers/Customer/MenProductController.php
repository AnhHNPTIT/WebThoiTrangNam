...
class TrousersProductController extends Controller
{
    public function index()
    {
        $products = Product::where('product_category_id', 2)->where('status', 1)->orderBy('price_sale')->paginate(20);
        return view('category_products', ['products' => $products, 'title' => 'Giày dép']);
    }

    public function trousersProduct(Request $request)
    {
