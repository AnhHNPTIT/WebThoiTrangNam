...
class UnderwearProductController extends Controller
{
    public function index()
    {
        $products = Product::where('product_category_id', 3)->where('status', 1)->orderBy('price_sale')->paginate(20);
        return view('category_products', ['products' => $products, 'title' => 'Đồ lót']);
    }

    public function underwearProduct(Request $request)
    {
