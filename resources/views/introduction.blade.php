                    ...
                    <div class="col-sm-24 em-col-main">
                        <div class="em_post-item">                           
                            <div class="" style="text-align : justify; padding: 10px 10px; line-height : 30px;">
                                ...
                                <p>Công ty cổ phần thời trang nam Thảo Nhi - Fashion Store là nơi chuyên cung cấp các thực phẩm chức năng cho mọi lứa tuổi.</p>
                                ...
                                <p>Mọi vấn đề thắc mắc, xin liên hệ số điện thoại hotline: (84-43) 566 6539 hoặc gửi thư tới địa chỉ: huonglt@gmail.com</p>
                            </div>
                        </div>
                    </div><!-- /.em-col-main -->
                </div>
